      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <div class ="d-flex">
                <h5 class="card-title flex-grow-1">Estudiantes</h5>

                <!-- Modal Crear Estudiante -->
                <!-- <button type="button" class="btn btn-primary btn-sm my-3" data-bs-toggle="modal" data-bs-target="#createStudent">
                  Crear Estudiante
                </button>
                  ...
                  <?php foreach ($students as $student) : ?>
                    <tr class="text-center">
                      ...
                      <td class="text-center pt-2">
                        ...
                        <a href="#" onclick="deleteRegister('Users','user',<?php echo $student->getUserId(); ?>)" class="btn btn-danger p-0 ms-1">
