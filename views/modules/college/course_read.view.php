                      ...
                      <div class="modal-body">
                          <form action="?c=Colleges&a=courseCreate" method="POST">
                            <!-- <div class="row mb-3">
                              ...
                              <div class="col-sm-9">
                                <input type="text" name="grade_id" class="form-control" value="<?php echo $courseCode ?>">
                              </div>
                            </div> -->
                            <div class="row mb-3">
                          ...
                          <form action="?c=Colleges&a=gradeUpdate" method="POST">
                            <?php if ($courseId) : ?>
                              <div class="row mb-3">
                                <label for="inputText" class="col-sm-3 col-form-label">Código</label>
                                <div class="col-sm-9">
                                  <label for="inputText" class="col-sm-9 col-form-label px-3"><?php echo $courseId->getCourseId() ?></label>
                ...
                <tbody>
                  <?php foreach ($courses as $course) : ?>
                    <tr class="text-center">
                      <td class="pt-3"><?php echo $course->getCourseId(); ?></td>
                      <td class="pt-3"><?php echo $course->getCourseName(); ?></td>
                      <td class="text-center pt-2">
                        <a href="?c=Colleges&a=gradeUpdate&idgrade=<?php echo $course->getCourseId(); ?>" class="btn btn-success p-0">
                          <h4 class="m-0"><i class="p-1 ri-edit-circle-fill"></i></h4>
                        </a>
                        <a href="#" onclick="deleteRegister(<?php echo $course->getCourseId(); ?>, 'grade')" class="btn btn-danger p-0 ms-1">
