...
-- -----------------------------------------------------
-- Table `db_assistance`.`RESPONSIBLES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_assistance`.`RESPONSIBLES` (
...
-- -----------------------------------------------------
-- Table `db_assistance`.`RESPONSIBLES_STUDENTS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_assistance`.`RESPONSIBLES_STUDENTS` (
  `student_id` VARCHAR(20) NOT NULL,
  `responsible_id` VARCHAR(20) NOT NULL,
  INDEX `ind_attendant_student_student` (`student_id` ASC),
  INDEX `ind_attendant_student_attendant` (`responsible_id` ASC),
  ...
  CONSTRAINT `fk_attendant_student_attendant`
    FOREIGN KEY (`responsible_id`)
    REFERENCES `db_assistance`.`RESPONSIBLES` (`responsible_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_assistance`.`JOURNES_GRADES_COURSES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_assistance`.`JOURNES_GRADES_COURSES` (
  `student_id` VARCHAR(20) NOT NULL,
  `journe_id` INT NOT NULL,
  `grade_id` INT NOT NULL,
  `course_id` INT NOT NULL,
  PRIMARY KEY (`student_id`),
